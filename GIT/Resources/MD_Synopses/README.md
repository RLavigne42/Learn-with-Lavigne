# Per-File Deep Synopses and TOCs

This folder contains **one synopsis file per major top-level markdown document** in `GIT/Resources`.

Each companion file includes:
- purpose and usage guidance,
- extracted heading TOC,
- section-by-section takeaways pulled from the source text.

- [`Codex_GitHub_Training_Modules_Git_Fundamentals.synopsis.md`](./Codex_GitHub_Training_Modules_Git_Fundamentals.synopsis.md) — companion for `Codex & GitHub Training Modules_ Git Fundamentals.md`
...
- [`VS_Code_GitHub_Zero_to_Hero.synopsis.md`](./VS_Code_GitHub_Zero_to_Hero.synopsis.md) — companion for `VS Code & GitHub_ Zero to Hero.md`
